...
- Name: delete_api_test_20260518_195631.spec.ts >> DELETE /api/v2/projects/{project_identifier}/api-tests/{api_test_id} - 删除 API 测试 >> 3.1 重复删除同一 API 测试 - 第一次应成功，第二次应返回错误
- Location: tests\delete_api_test_20260518_195631.spec.ts:100:7
...
Call log:
  - → DELETE https://api.example.com/api/v2/projects/PR-1/api-tests/test-to-delete-twice
