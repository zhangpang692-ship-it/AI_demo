...
- Name: delete_api_test_20260518_195631.spec.ts >> DELETE /api/v2/projects/{project_identifier}/api-tests/{api_test_id} - 删除 API 测试 >> 2.1 删除不存在的 API 测试 - 应返回 404 或 422
- Location: tests\delete_api_test_20260518_195631.spec.ts:41:7
...
Call log:
  - → DELETE https://api.example.com/api/v2/projects/PR-1/api-tests/non-existent-test-id
