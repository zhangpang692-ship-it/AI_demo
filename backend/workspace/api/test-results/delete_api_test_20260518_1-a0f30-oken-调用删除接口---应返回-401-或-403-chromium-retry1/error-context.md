...
- Name: delete_api_test_20260518_195631.spec.ts >> DELETE /api/v2/projects/{project_identifier}/api-tests/{api_test_id} - 删除 API 测试 >> 4.2 无效/伪造的 Token 调用删除接口 - 应返回 401 或 403
- Location: tests\delete_api_test_20260518_195631.spec.ts:149:7
...
Call log:
  - → DELETE https://api.example.com/api/v2/projects/PR-1/api-tests/test-id-123
