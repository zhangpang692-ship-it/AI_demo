...
- Name: delete_api_test_20260518_195631.spec.ts >> DELETE /api/v2/projects/{project_identifier}/api-tests/{api_test_id} - 删除 API 测试 >> 2.2 无效的 project_identifier - 应返回 422
- Location: tests\delete_api_test_20260518_195631.spec.ts:60:7
...
Call log:
  - → DELETE https://api.example.com/api/v2/projects/non-existent-project/api-tests/test-id-123
